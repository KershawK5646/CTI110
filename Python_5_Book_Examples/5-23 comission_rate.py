...
def main():
    # Get the ammount of sales.
    sales = get_sales()

    # Determine the amount of advanced pay.
...
def get_sales():
    # Get the ammount of monthly sales.
...
# advanced pay given to the sales person and returns
# that amount.
...
def determine_comm_rate(sales):
    ...
    if sales < 10000.00:
        ...
        rate = 0.12
    elif sales >= 15000and sales <= 17999.99:
        rate = 0.14
